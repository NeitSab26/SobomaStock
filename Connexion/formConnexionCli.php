...
<body>
    ...
    <form class="container mx-20" action="./actionFormCli.php" method="post">
        <h2>Connexion Client.</h2>
        <div class="form-group">
            <label for="exampleInputEmail1" class="form-label mt-4">Mail</label>
            <input type="email" class="form-control" name="mailCli" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Entrez votre Mail">
        ...
        <div class="form-group">
            ...
            <input type="password" class="form-control" name="mdpCli" id="exampleInputPassword1" placeholder="Entrez votre mot de passe">
        </div><br>
        <div class="form-group">
